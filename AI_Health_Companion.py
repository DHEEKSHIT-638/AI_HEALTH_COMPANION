...
# Configure API key(I used Gemini key)
GOOGLE_API_KEY= "AIzaSyCevlpASEuo0VgWWep-qMFryrtezLAEK0k"   #insert your  API key incase of key expiry https://aistudio.google.com/apikey
